...
class AcDbLine implements AcDbEntity {
  ...
  static Future<AcDbLine> fromGroupCodes(List<GroupCode> codes) async {
    ...
    result = codes.lastWhereOrNull((element) => element.code == 10);
    if (result != null) {
      _acDbEntity._x1 = double.parse(result.value);
    }

    result = codes.lastWhereOrNull((element) => element.code == 20);
    if (result != null) {
      _acDbEntity._y1 = double.parse(result.value);
    }

    result = codes.lastWhereOrNull((element) => element.code == 30);
    if (result != null) {
  ...
  double get x1 => _x1;
  set x1(double value) {
    var result = _groupCodes.lastWhereOrNull((element) => element.code == 10);
    if (result != null) {
      _x1 = value;
      result.value = value;
    }
  ...
  double get y1 => _y1;
  set y1(double value) {
    var result = _groupCodes.lastWhereOrNull((element) => element.code == 20);
    if (result != null) {
      _y1 = value;
      result.value = value;
    }
  ...
  double get z1 => _z1;
  set z1(double value) {
    var result = _groupCodes.lastWhereOrNull((element) => element.code == 30);
    if (result != null) {
      _z1 = value;
      result.value = value;
    }
